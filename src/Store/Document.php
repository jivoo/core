...
class Document implements \ArrayAccess, \IteratorAggregate
{
    ...
    /**
     * Associatve array of key-value pairs for current subset.
     *
     * @var array
     */
    ...
    /**
     * Associative array of default values for current subset.
     *
     * @var array
     */
    ...
    /**
     * Whether to save default values.
     *
     * @var bool
     */
    ...
    /**
     * True if document has been changed (only has meaning in the root document).
     *
     * @var bool
     */
     ...
     *            The document key to access.
     * @param mixed $value
     *            The value or subarray to associate with the key.
     */
    ...
    /**
     * Retreive value of a document key.
    ...
    public function get($key, $default = null)
    {
        if (isset($this->data[$key])) {
            ...
            } elseif (isset($this->defaultData[$key])) {
