 ...
 * See subclasses for implementations of file formats.
 */
abstract class FileStore implements Store
{
    ...
    /**
     * Default file content (used by {@see touch()}). Should result in en empty
     * document array, e.g. <code>array()</code>.
     *
     * @var string
     */
     ...
     */
    abstract protected function decode($content);
