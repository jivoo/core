...
/**
 * A PSR-4 autoloader implementation.
 * A singleton instance of this class is
 * used by Jivoo.
 */
class Autoloader
{
     ...
     *
     * @param bool $prepend
     *            If true, the autolaoder will be prepended instead of
     *            appended.
     */
     ...
     *            Namespace prefix (i.e. with trailing backslash).
     * @param string $path
     *            Directory path.
     * @param bool $prepend
     *            If true, the path will be prepended instead of
     *            appended.
     * @param bool $psr0
     *            Whether to use PSR-0 instead of PSR-4 for this path.
     */
