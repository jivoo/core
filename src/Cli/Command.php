...
interface Command
{
     ...
     *
     * @param string $option
     *            The long option (as returned by {@see getOptions}),
     *            e.g. 'help' or 'file'.
     ...
     *            Option to describe, if null, the method should
     ...
     *            List of parameters for command.
     * @param string[] $options
     *            Associative array of options for command,
     */
