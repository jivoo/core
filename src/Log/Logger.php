...
/**
 * Default Jivoo logger that can log to one or more log handlers.
 * It also keeps
...
class Logger implements LoggerInterface
{
     ...
     *            Log handler.
     * @param bool $getsPrevious
     *            Whether this log handler should get a batch of
     *            all previously logged messages.
     * @param bool $prepend
     *            If true, the handler is prepended instead of appended.
     */
     ...
     *
     * @param string $levelA
     *            First log level, see {@see LogLevel}.
     * @param string $levelB
     *            Second log level.
